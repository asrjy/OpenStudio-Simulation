...
require 'D:\cS\Zodhya\git-repos\OpenStudio-Simulation\openstudio-standards\lib\openstudio-standards.rb' # Change to the path where openstudio-standards is cloned
require 'fileutils'
require 'parallel'
