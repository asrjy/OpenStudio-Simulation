require 'D:\openstudio-2.9.1\Ruby\openstudio.rb' # Change to the path where OpenStudio is installed
require 'D:\cS\Zodhya\git-repos\OpenStudio-Simulation\openstudio-standards-old\lib\openstudio-standards.rb' # Change to the path where openstudio-standards is cloned
require 'fileutils'
require 'parallel'
...
measures_dir = 'D:/cS/Zodhya/git-repos/OpenStudio-Simulation/OpenStudio-measures/'
epws_path = './EPWs'
...
number_of_stochastic_occupancy_simulation = 1
...
run_osws(
    'openstudio', # Change this to your command name of OpenStudio 2.9.1.
